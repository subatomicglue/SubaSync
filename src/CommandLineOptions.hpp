...
inline const std::vector<CommandLineOptions::SettingSpec>& CommandLineOptions::setting_specs() {
...
inline const std::vector<CommandLineOptions::ArgvSpec>& CommandLineOptions::argv_specs() {
...
inline void CommandLineOptions::apply_defaults() {
...
inline const CommandLineOptions::SettingSpec* CommandLineOptions::find_spec(const std::string& token) const {
...
inline void CommandLineOptions::init(int argc, char* argv[]) {
...
inline void CommandLineOptions::usage() const {
...
inline void CommandLineOptions::parse_args(int argc, char* argv[]) {
...
inline bool CommandLineOptions::has(const std::string& key) const {
  return settings_.contains(key);
}

inline std::vector<std::string> CommandLineOptions::keys() const {
...
inline std::string CommandLineOptions::value_as_string(const std::string& key) const {
...
inline std::filesystem::path CommandLineOptions::settings_path() const {
  return std::filesystem::current_path() / "share" / ".config" / "settings.json";
}

inline bool CommandLineOptions::load() {
...
inline void CommandLineOptions::merge_from_json(const nlohmann::json& doc) {
...
inline bool CommandLineOptions::save() const {
  auto path = settings_path();
  std::error_code ec;
...
inline bool CommandLineOptions::convert_and_store(const SettingSpec& spec,
...
inline nlohmann::json CommandLineOptions::parse_string_value(const SettingSpec& spec,
...
inline bool CommandLineOptions::set_from_string(const std::string& key,
                                                const std::string& value,
                                                std::string& error) {
...
inline bool CommandLineOptions::set(const std::string& key,
                                    const nlohmann::json& value,
                                    std::string& error) {
  const auto* spec = find_spec(key);
  if(!spec) {
...
inline std::string CommandLineOptions::to_lower(std::string value) {
  std::transform(value.begin(), value.end(), value.begin(),
                 [](unsigned char ch){ return static_cast<char>(std::tolower(ch)); });
  return value;
}

inline std::string CommandLineOptions::trim_copy(std::string value) {
...
inline std::string CommandLineOptions::default_to_string(const SettingSpec& spec) const {
  if(spec.type == "bool") {
...
inline std::optional<std::string> CommandLineOptions::resolve_key(const std::string& token) const {
...
template<typename T>
inline T CommandLineOptions::get(const std::string& key) const {
  if(!has(key)) {
